...
class SimpleProduct {
  ...
  @override
  String toString() {
    return 'Data{guid: $guid, storeGuid: $storeGuid, inCart: $inCart, storeName: $storeName, productOptionGuid: $productOptionGuid, title: $title, price: $price, imageUrl: $imageUrl, isFavorite: $isFavorite}';
  }
}
