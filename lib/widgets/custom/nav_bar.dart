...
const double _kNavBarPersistentHeight = 58;
...
/// to also has a [CupertinoNavigationBar] or a [MyCustomCupertinoSliverNavigationBar]
...
///
/// By default, only one [CupertinoNavigationBar] or [MyCustomCupertinoSliverNavigationBar]
...
///  * [MyCustomCupertinoSliverNavigationBar] for a navigation bar to be placed in a
...
class CupertinoNavigationBar extends StatefulWidget
  ...
  /// [MyCustomCupertinoSliverNavigationBar] instances of the same [Navigator]. With the
...
///
/// The [MyCustomCupertinoSliverNavigationBar] must be placed in a sliver group such
...
///
/// {@tool dartpad}
/// This example shows [MyCustomCupertinoSliverNavigationBar] in action inside a [CustomScrollView].
///
...
class MyCustomCupertinoSliverNavigationBar extends StatefulWidget {
  /// Creates a navigation bar for scrolling lists.
  ///
  /// The [largeTitle] argument is required and must not be null.
  const MyCustomCupertinoSliverNavigationBar({
    Key? key,
    this.largeTitle,
    this.leading,
    this.automaticallyImplyLeading = true,
  ...
  @override
  State<MyCustomCupertinoSliverNavigationBar> createState() =>
      _MyCustomCupertinoSliverNavigationBarState();
}

// A state class exists for the nav bar so that the keys of its sub-components
// don't change when rebuilding the nav bar, causing the sub-components to
// lose their own states.
class _MyCustomCupertinoSliverNavigationBarState
    extends State<MyCustomCupertinoSliverNavigationBar> {
  late _NavigationBarStaticComponentsKeys keys;
...
/// [MyCustomCupertinoSliverNavigationBar]'s `leading` slot when
/// `automaticallyImplyLeading` is true.
///
