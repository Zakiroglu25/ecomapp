...
class MyText {
  ...
  static const String on_boardTwoBig = "Let’s find your personal doctor";
  static const String on_boardTwoLittle =
      "Clinical excellence must be the priority for any health care service provider";
  static const String on_boardThreeBig = "Choose your desired receipts";
  static const String on_boardThreeLittle =
      "Clinical excellence must be the priority for any health care service provider";
  ...
  static const String rules = '''1. What Are Mobile App Terms and Conditions?
...
App terms and conditions help protect the owner’s intellectual property, and allow them to prohibit unwanted user activity and terminate user accounts that violate their terms.

2. How Are App Terms and Conditions  Different From A Disclaimer or Privacy Policy?

App terms and conditions are different from disclaimers and privacy policies because terms and conditions outline your rights and rules for your app, whereas disclaimers help reduce legal liabilities and privacy policies disclose your data handling practices.
