...
abstract class AppTextStyles {
  ...
  //
  // static const proxi700 = TextStyle(
  //     fontFamily: 'ProximaNova-Bold',
  //     fontWeight: FontWeight.w700,
  //     fontStyle: FontStyle.normal,
  //     letterSpacing: 0.3);
  // static const proxi700s24 = TextStyle(
  //     fontFamily: 'ProximaNova-Bold',
  //     fontSize: 24,
  //     fontWeight: FontWeight.w700,
  //     fontStyle: FontStyle.normal,
  //     letterSpacing: 0.3);
  //
  // static const proxi500 = TextStyle(
  //     fontFamily: 'ProximaNova-Regular',
  //     fontWeight: FontWeight.w500,
  //     fontStyle: FontStyle.normal,
  //     letterSpacing: 0.3);
  // static const proxi500s13 = TextStyle(
  //     fontFamily: 'ProximaNova-Regular',
  //     fontWeight: FontWeight.w500,
  //     fontSize: 13,
  //     fontStyle: FontStyle.normal,
  //     letterSpacing: 0.3);
  // static const proxi400s12 = TextStyle(
  //     fontFamily: 'ProximaNova-Regular',
  //     fontSize: 12,
  //     fontWeight: FontWeight.w400,
  //     fontStyle: FontStyle.normal,
  //     letterSpacing: 0.3);
  //
  // static const proxi400s14 = TextStyle(
  //     fontFamily: 'ProximaNova-Regular',
  //     fontSize: 14,
  //     fontWeight: FontWeight.w400,
  //     fontStyle: FontStyle.normal,
  //     letterSpacing: 0.3);
  //
  // static const proxi400s16 = TextStyle(
  //     fontFamily: 'ProximaNova-Regular',
  //     fontSize: 16,
  //     fontWeight: FontWeight.w400,
  //     fontStyle: FontStyle.normal,
  //     letterSpacing: 0.3);
  // static const proxi600 = TextStyle(
  //     fontFamily: 'ProximaNova-SemiBold',
  //     fontWeight: FontWeight.w600,
  //     fontStyle: FontStyle.normal,
  //     letterSpacing: 0.3);
  // static const proxi600s16 = TextStyle(
  //     fontFamily: 'ProximaNova-SemiBold',
  //     fontWeight: FontWeight.w600,
  //     fontStyle: FontStyle.normal,
  //     fontSize: 16,
  //     letterSpacing: 0.3);
  // static const proxi600s24 = TextStyle(
  //     fontFamily: 'ProximaNova-SemiBold',
  //     fontSize: 24,
  //     fontWeight: FontWeight.w600,
  //     fontStyle: FontStyle.normal,
  //     letterSpacing: 0.3);
  //
  // static const proxi600s30 = TextStyle(
  //     fontFamily: 'ProximaNova-SemiBold',
  //     fontSize: 30,
  //     fontWeight: FontWeight.w600,
  //     fontStyle: FontStyle.normal,
  //     letterSpacing: 0.3);
  //
  // static const proxi400h2 = TextStyle(
  //     fontFamily: 'ProximaNova-Regular',
  //     fontSize: 14,
  //     fontWeight: FontWeight.w400,
  //     fontStyle: FontStyle.normal,
